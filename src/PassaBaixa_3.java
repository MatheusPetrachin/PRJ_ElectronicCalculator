...
public class PassaBaixa_3 {
	...
	PassaBaixa_3(double c3, double fc, String nome){
		this.c3 = c3;
		this.fc = fc;
		this.nome = nome;
		this.constroi_filtro_PB_3();
	}
	...
	void constroi_filtro_PB_3() {
		this.c1 = this.c3/2;
		this.r1 = 0.707/(2*Math.PI*this.fc*this.c3);
		this.c2 = this.c3*2;
		this.r2 = this.r1;
		this.r3 = this.r1;
		this.rf = 2*this.r1;
